...
let envValues = {
  ...
  db: {
    url: 'mongodb://localhost:27017/pix'
    //url: 'mongodb://ip172-18-0-69-bu3ndp7p2ffg00e6esh0-27017.direct.labs.play-with-docker.com:27017'
...
if (process.env.NODE_ENV === 'prod') {
  ...
  envValues = {
    db: {
      url: 'mongodb://localhost:27017/pix4fun-test'
    }
  }
}
// const config = {
